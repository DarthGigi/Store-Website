...
<header>
  <div id="infoMenu" class="pointer-events-auto fixed left-0 top-0 z-50 w-full items-start px-4 md:flex md:backdrop-blur lg:z-0 lg:backdrop-blur-none">
    <div class="items-left flex flex-col items-start pl-10 pb-4 pt-10">
      <span id="infoMenuTier" class="text-4xl font-bold text-white">Sirius</span>
      ...
      <div class="mt-4 scale-100 transform flex-col items-start text-neutral-300 opacity-100 duration-500">
