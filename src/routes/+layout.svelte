...
<svelte:head>
	...
	<meta
		name="description"
		content="Upgrade your experience by purchasing Sirius Pro or Essential at our Store."
	/>
	...
	<link
		...
		sizes="180x180"
		href="/assets/images/favicons/apple-touch-icon.png?v=2"
	/>
	<link
		rel="icon"
		type="image/png"
		sizes="32x32"
		href="/assets/images/favicons/favicon-32x32.png?v=2"
	/>
	<link
		rel="icon"
		type="image/png"
		sizes="16x16"
		href="/assets/images/favicons/favicon-16x16.png?v=2"
	/>
